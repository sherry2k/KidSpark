...
const PuzzleGame: React.FC<PuzzleGameProps> = ({ progress, onBack, onComplete }) => {
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 overflow-y-auto py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl w-full">
              ...
              >
                ...
                <h3 className="text-xl font-black mb-1" style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}>
                  Shape Match
                </h3>
    ...
    return (
      <GameBackground variant="game">
        <div className="h-full flex flex-col items-center justify-center px-4">
          <Celebration show={true} message="All Puzzles Complete!" stars={3} />
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <motion.button
                onClick={nextLevel}
                className="bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-2xl py-4 font-black shadow-lg border-4 border-white"
                style={{
  ...
  if (puzzleType === 'shape-match') {
    ...
    if (allMatched && !showQuickSuccess && !showCelebration) {
        ...
        <div className="h-full flex flex-col">
          ...
          <AnimatePresence>
            {showQuickSuccess && (
              ...
              >
                <motion.div
                  className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-3xl p-8 shadow-2xl border-4 border-white text-white text-center"
                ...
                >
                  ...
                  <p className="text-2xl font-black" style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}>
                    Great Job!
                  </p>
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 pb-4">
            <motion.p
              className="text-lg md:text-xl font-black text-gray-700 mb-6 bg-white/80 rounded-full px-6 py-2 shadow-md"
              style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}
            ...
            <div className="w-full max-w-md space-y-6">
              <div>
                <p className="text-center text-sm font-black text-gray-600 mb-2">Pictures:</p>
              ...
              <div>
                <p className="text-center text-sm font-black text-gray-600 mb-2">Match with:</p>
                <div className="grid grid-cols-4 gap-3">
                  {level.items.map((item) => {
      ...
      <GameBackground variant="game">
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 pb-4">
            ...
            <p 
              className="text-lg font-black text-gray-700 mb-4"
              style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}
            >
              Choose your answer:
            </p>
    ...
    return (
      <GameBackground variant="game">
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4 pb-4">
            <motion.p
              className="text-lg md:text-xl font-black text-gray-700 mb-4 bg-white/80 rounded-full px-6 py-2 shadow-md text-center"
              style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}
              initial={{ y: -10, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            >
            ...
            <div className="bg-white/95 rounded-3xl p-4 md:p-6 shadow-xl border-4 border-white mb-4 w-full max-w-md">
              <div className="flex items-center gap-2 mb-2 text-xs text-gray-600 font-black">
                <span>SMALL</span>
            ...
            <p 
              className="text-lg font-black text-gray-700 mb-3"
              style={{ fontFamily: "'Fredoka', 'Arial Black', sans-serif" }}
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full max-w-md">
              {availableItems.map((item, i) => (
                ...
                >
                  ...
                  <span className="text-xs font-black text-gray-600 mt-1">
                    {item.label}
                  </span>
                </motion.button>
              ))}
            ...
            {sortedItems.length > 0 && (
              <motion.button
                onClick={handleReset}
                className="mt-4 bg-orange-400 text-white rounded-2xl px-6 py-3 font-black shadow-lg border-4 border-white"
                style={{
