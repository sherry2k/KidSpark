  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "KidSpark",
        description:
          "An educational game for children aged 4-8. Learn letters, numbers, shapes, colors, animals and more through fun interactive games! Features quizzes, memory games, puzzles, coloring, math adventures, and real-world skills."
        start_url: "/",
        id: "/",
        display: "standalone",
